...
const EN_S = [
  ...
  { t: "3. Service not delivered",       b: "If a Hero fails to deliver through no fault of yours, you are entitled to a full refund. Raise a dispute within 24 hours at admin@bharat333.com with your booking ID." },
  ...
  { t: "5. Cash payments",               b: "Cash refunds are settled directly with the Hero and facilitated by your Bharat Services Regional Officer. Contact admin@bharat333.com to initiate." },
  ...
  { t: "8. Contact",                     b: "Refund inquiries: admin@bharat333.com — include your booking ID and a brief description." },
];
...
const HI_S = [
  ...
  { t: "3. सेवा न मिलने पर",              b: "यदि हीरो आपकी गलती के बिना सेवा देने में विफल रहता है, तो आप पूर्ण रिफंड के हकदार हैं। 24 घंटे में admin@bharat333.com पर बुकिंग ID के साथ विवाद दर्ज करें।" },
  ...
  { t: "5. नकद भुगतान",                   b: "नकद रिफंड हीरो के साथ सीधे और आपके Bharat Services रीजनल ऑफिसर की सहायता से होता है। शुरू करने के लिए admin@bharat333.com पर संपर्क करें।" },
  ...
  { t: "8. संपर्क",                       b: "रिफंड पूछताछ: admin@bharat333.com — बुकिंग ID और समस्या का संक्षिप्त विवरण जरूर शामिल करें।" },
];
